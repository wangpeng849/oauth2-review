...
public class TokenTask {
    ...
    //首先在 getData 方法中，如果 access_token 为空字符串，并且 code 不为 null，表示这是刚刚拿到授权码的时候，准备去申请令牌了，令牌拿到之后，将 access_token 和 refresh_token 分别赋值给全局变量，然后调用 loadDataFromResServer 方法去资源服务器加载数据。
